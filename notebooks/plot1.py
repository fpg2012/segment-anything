...
def plot_border_attn_drop():
    ...
    ax[0, 0].bar(x - width/2*3, bas7_1024, width, label='image_size=1024')
    ax[0, 0].bar(x - width/2, bas7_2048, width, label='image_size=2048')
    ax[0, 0].bar(x + width/2, bas7_1024_i, width, label='image_size=1024i')
    ...
    ax[0, 1].bar(x - width/2*3, bas15_1024, width, label='image_size=1024')
    ...
    ax[1, 0].bar(x - width/2*3, bas23_1024, width, label='image_size=1024')
    ...
    ax[1, 1].bar(x - width/2*3, bas31_1024, width, label='image_size=1024')
